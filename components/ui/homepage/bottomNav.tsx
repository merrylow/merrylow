...
const BottomNavigation = () => {
     return (
     <section className="fixed bottom-0 left-0 w-full h-28 flex items-center justify-center bg-slate-800 border-t border-gray-200 shadow-lg text-white">
          <div className="w-[94%] flex justify-between items-center px-4 py-2">
               ...
               <Link href="/order-now" className="text-gray-500 hover:text-blue-500">
                    <div>
